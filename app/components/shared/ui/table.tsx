...
function TableBody({ className, ...props }: React.ComponentProps<"tbody">) {
  return <tbody data-slot="table-body" className={cn("[&_tr:last-child]:border-0  text-foreground ", className)} {...props} />;
}
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return <tr data-slot="table-row" className={cn(" data-[state=selected]:bg-muted border-b transition-colors  text-foreground dark:hover:bg-muted light:hover:bg-gray-200", className)} {...props} />;
}
